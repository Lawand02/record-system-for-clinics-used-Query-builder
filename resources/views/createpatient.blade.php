...
<form action="{{url('patient/create')}}" method="POST" class="row g-3">
  @csrf
    <div class="col-md-4">
    ...
    <div class="col-12">
        <div class="col-md-4">
            ...
            <input type="text" name="Doctor_name" class="form-control" id="validationDefault02" placeholder="Doctor name" required>
          </div>
